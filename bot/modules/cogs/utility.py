...
class Utility(commands.Cog):
    ...
    @command(
        ...
        examples=["{prefix}cdn https://cdn.discordapp.com/attachments/381963689470984203/1068926488453332993/sQWxQyB.jpg"]
    )
    async def cdn_upload(self, ctx: commands.Context, file: str = commands.param(description="Parameter if using a URL, you don't need to pass this if you add an attachment to your message", default=None)):
        ...
        async with ctx.typing():
            ...
            async with await self.bot.session.post(
                ...
                if not data.get("error", False):
                    ...
                    message = data.get("exception", "Error occured but exception key does not exist.")
